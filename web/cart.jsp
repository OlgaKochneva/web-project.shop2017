               ...
               <c:if test="${empty sessionScope.purchases.purchases}">
                ...
                <c:if test="${not empty sessionScope.purchases.purchases}">
                    <table class="tab" border="1px">
                        <thead class="main">
                            <td ></td><td><fmt:message key="titlesh"/></td><td ><fmt:message key="count"/></td><td><fmt:message key="pr2"/></td><td width="30px"></td>
                        </thead>
                        ...
                        <tr style="border-top-color: #fffbf7">
                            ...
                            <td ><a class=myLin href="/no_login.jsp"><fmt:message key="btn_order"/></a></td>
                        </tr>
                    </table>
